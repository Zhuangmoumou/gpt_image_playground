          ...
          {task.status === 'done' && outputLen > 0 && currentOutputPreviewSrc && (
            <>
              <img
                ...
                alt=""
              />
              <div data-selectable-text className="absolute left-4 top-[15px] flex flex-wrap items-center gap-1.5">
                {formatDuration() && (
