...
export interface ApiProfile {
  ...
  providerDrafts?: Partial<Record<ApiProvider, Partial<Pick<ApiProfile, 'baseUrl' | 'model' | 'apiMode' | 'codexCli' | 'apiProxy' | 'useServerSideRequests' | 'responseFormatB64Json' | 'streamImages' | 'streamPartialImages'>>>>
}
...
export interface AppSettings {
  ...
  copyImportUrlUseNewApiAddress: boolean
  copyImportUrlUseNewApiKey: boolean
  copyImportUrlUseNewApiModel: boolean
  profiles: ApiProfile[]
